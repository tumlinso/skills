...
1. `SK-WF2-C01` — Expose read-only indexed ctxpp queries
2. `SK-WF2-C02` — Remove opportunistic Todo imports from source identity
3. `SK-WF2-C03` — Strengthen packet schemas and trust accounting
4. `SK-WF2-C04` — Harden query publication and resource bounds
5. `SK-WF2-C05` — Qualify independent consumers and publish the ctxpp API
