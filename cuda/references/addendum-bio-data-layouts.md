...
5. Resume the main `cuda` workflow once the data and phase boundaries are clear.
...
- what information should be carried into the main `cuda` workflow for low-level optimization
