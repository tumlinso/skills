...
Use this reference only after `references/addendum-tensor-core-routing.md` has established that the workload is genuinely Tensor Core-eligible and that cuBLAS, cuBLASLt, or CUTLASS still leave a stable gap on Tesla V100 16 GB `sm_70`.
